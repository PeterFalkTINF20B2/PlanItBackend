...
//		setAppointmentFilePath(directoryPath + File.separator + "appointments.txt");
	 ...
	 * String
	 */
	public String convertAppointmentModelListToJSON(ArrayList<AppointmentModel> appntmnts)
...
//			throw Exception
	...
	/*
	 * Takes given appointment, searches Id, then replaces old appointment with same
	 * Id
	 */
